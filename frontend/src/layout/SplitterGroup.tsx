...
// 5 px draggable divider between two adjacent panes — Terminal theme.
const Divider: React.FC<{
  ...
  <div
    ...
    onMouseEnter={(e) => {
      if (!disabled) {
        (e.currentTarget as HTMLDivElement).style.background = "oklch(72% 0.18 145 / 0.35)";
        (e.currentTarget as HTMLDivElement).style.boxShadow = "0 0 16px oklch(72% 0.18 145 / 0.18)";
      }
    }}
    onMouseLeave={(e) => {
      (e.currentTarget as HTMLDivElement).style.background = "linear-gradient(180deg, transparent, var(--color-border), transparent)";
